...
class List{
	...
	while ((!var_end) && (!ret_val)){
          ...
          if(var_end) System.out.println(1); else System.out.println(0);
          if(ret_val) System.out.println(1); else System.out.println(0);
	    if (e.Equal(var_elem)){
              System.out.println(991199);
		ret_val = true ;
		if (aux04 < 0) { 
                  System.out.println(119911);
		    // delete first element
		    my_head = aux01.GetNext() ;
		} 
		else{ // delete a non first element
		    System.out.println(zero-555);
