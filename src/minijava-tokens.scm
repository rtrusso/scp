...
;; minijava language.  First it defines some character sets, then
;; combines them into regular expressions, defines a table of token
;; types based on those regular expressions, and finally invokes the
;; scanner generator library with that table to write out the actual
;; lexer.

;; library code declarations (analogous to header files or import
;; declarations) these are not part of any scheme standard but rather
;; my own convention
;;
...
(define lexer-filename "minijava-lexer.scm")
